   ...
   MathSolver mathSolver;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.appsUpdate_cl).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (MyInternetCon.checkConnection(getContext())) {
                    sNewActivityAds(new ScanningActivity());
                 }
                else
        ...
        view.findViewById(R.id.allApps_cl).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sNewActivityAds(new AppsActivity());
                 }
        });
        ramAndStorageFun();
        return view;
...
//for Ram
        ...
        @SuppressLint("DefaultLocale") String ramUsagePercentage = String.format("%.1f", mathSolver.getPercentageFloat(totalMemory, usedMemory)) + "%";
//
...
//        systemAndAppsSize_tv.setText(mathCalculationsUtil.getCalculatedDataSizeWithPrefix(usedMemory));
        freeRam_tv.setText("Free: "+mathSolver.getCalculatedDataSizeWithPrefix(freeMemory));
        totalRam_tv.setText("Total RAM size: "+mathSolver.getCalculatedDataSizeWithPrefix(totalMemory));
